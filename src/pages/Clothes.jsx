...
function Clothes({ addToCart }) {
  ...
  const filters = ['All', 'Dresses', 'Tops', 'Skirts', 'Outerwear']

  const filteredProducts = activeFilter === 'All'
    ? clothesProducts
    : clothesProducts.filter((product) => product.subcategory === activeFilter)
  ...
  return (
    <div>
      <div className="page-header">
        <h1>Clothes</h1>
        <p>DISCOVER OUR LATEST APPAREL COLLECTION</p>
      </div>
