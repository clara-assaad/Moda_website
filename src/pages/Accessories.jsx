...
function Accessories({ addToCart }) {
  ...
  const filters = ['All', 'Jewelry', 'Belts', 'Scarves', 'Sunglasses']

  const filteredProducts = activeFilter === 'All'
    ? accessoriesProducts
    : accessoriesProducts.filter((product) => product.subcategory === activeFilter)
  ...
  return (
    <div>
      <div className="page-header">
        <h1>Accessories</h1>
        <p>DISCOVER OUR LATEST ACCESSORIES COLLECTION</p>
      </div>
